...
const Edit = ({attributes, setAttributes}) => {
    ...
    if(categories === null) {
        wp.apiFetch({path: '/wp/v2/vimeify-category'}).then(data => createCategoriesOptions(data.map((x) => {
            return {label: x.name, value: x.id}
        })));
    }
    ...
    return (
        <>
            <div {...blockProps}>
                {
                    <InspectorControls>
                        <div className="vimeify-inspector-controls-block">
                            <fieldset>
                                <SelectControl
                ...
                <div className="vimeify-block-preview vimeify-table-wrapper table-responsive ">
                    <table className="vimeify-table table" border="0">
                        <thead>
                        <tr>
                            <th className="vimeify-head-title">Title</th>
                            <th className="vimeify-head-date">Date</th>
                            <th className="vimeify-head-actions">Actions</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                            <td className="vimeify-row-title">Exaple vimeo video #1</td>
                            <td className="vimeify-row-date">January 01, 2023</td>
                            <td className="vimeify-row-actions">
                        ...
                        <tr>
                            <td className="vimeify-row-title">Exaple vimeo video #2</td>
                            <td className="vimeify-row-date">January 02, 2023</td>
                            <td className="vimeify-row-actions">
                                <a href="#" target="_blank" title="View">
                                    <span className="vimeify-eye"></span>
                                </a>
                        ...
                        <tr>
                            <td className="vimeify-row-title">Exaple vimeo video #3</td>
                            <td className="vimeify-row-date">January 03, 2023</td>
                            <td className="vimeify-row-actions">
                                <a href="#" target="_blank" title="View">
                                    <span className="vimeify-eye"></span>
                                </a>
